const listItems = [
    ...
    { id: 6, name: 'karim', family: 'Saeedi Rad' },
...
function setupPagination(allUesrsArray,pagesContainer, rowsCount){
    ...
    for (i=1 ; i<pageCount+1; i++){
       let createdBtn= paginaionButtonGenerator(i)
       pagesContainer.append(createdBtn)
       console.log(createdBtn)
    }
}


function paginaionButtonGenerator(page){
...
button.addEventListener('click',function(){
    ...
    let prevActive = document.querySelector('button.active')
